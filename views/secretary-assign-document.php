...
$document = $documentRouteModel->getSecretaryAssignment((int) $routeId, $officeId, $userId);
...
$documentRoutes = $documentRouteModel->getOfficePath($documentId);
...
$members = (new User())->getAssignableOfficeMembers($officeId, $userId);
